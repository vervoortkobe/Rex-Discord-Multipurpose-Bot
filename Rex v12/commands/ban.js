...
module.exports.run = async (client, message, args) => {
    ...
    if(!message.guild.me.permissions.has("BAN_MEMBERS")) {
      ...
      .setColor(0xf04947)
      .setDescription(`${x} **|** ***I couldn't ban this user, because I don't have ban permissions!***`)
    ...
    if(!message.member.permissions.has("BAN_MEMBERS")) {
      const errorEmbed = new Discord.MessageEmbed()
      .setColor(0xf04947)
      .setDescription(`${x} **|** ***I couldn't ban this user, you don't have the correct permissions (BAN_MEMBERS) to do this!***`)
      return message.channel.send(errorEmbed);
    }
    ...
    if(!args[0]) {
      ...
      .setColor(0xf04947)
      .setAuthor(`⚙️ | Ban`)
      .setDescription(`${x} **|** ***Usage: ${prefix}ban <@user/user ID> [reason]***`)
    ...
    if(member.bot) {
      const errorEmbed = new Discord.MessageEmbed()
      .setColor(0xf04947)
      .setDescription(`${x} **|** ***You can't ban a bot!***`)
      return message.channel.send(errorEmbed);
    }
    ...
    const banEmbed = new Discord.MessageEmbed()
    .setColor(0x43b481)
    .setDescription(`${v} **|** ***${member.tag} has been banned, because of ${reason}!***`)
    message.channel.send(banEmbed);
    ...
    if(logChannel) {
      ...
      .setDescription(`**» MEMBER_BAN_ADD:**\n${message.author} **banned ${member.tag}, because of ${reason}**!`)
      .setFooter(`${message.guild.name} now has ${message.guild.memberCount} members!`)
      logChannel.send(banLogEmbed);
    }
  }
