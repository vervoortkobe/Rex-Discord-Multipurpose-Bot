...
module.exports.run = async (client, message, args) => {
  ...
  if(args[0] === `other`) {
    ...
    .addField(`📁 | Other (13)`, `\`${prefix}apply\`, \`${prefix}avatar\`, \`${prefix}giveaway\`, \`${prefix}nickname\`, \`${prefix}onetwo\`, \`${prefix}poll\`, \`${prefix}say\`, \`${prefix}servercount\`, \`${prefix}serverinfo\`, \`${prefix}servericon\`, \`${prefix}verify\`, \`${prefix}whois\`, \`${prefix}yesno\``, true)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
  ...
  if(args[0] === `about`) {
    ...
    .addField(`📥 | About (13)`, `\`${prefix}aliases\`, \`${prefix}api\`, \`${prefix}botchangelog\`, \`${prefix}botinfo\`, \`${prefix}commandlist\`, \`${prefix}donate\`, \`${prefix}invite\`, \`${prefix}ping\`, \`${prefix}site\`, \`${prefix}supportus\`, \`${prefix}support\`, \`${prefix}version\`, \`${prefix}youtube\``)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
