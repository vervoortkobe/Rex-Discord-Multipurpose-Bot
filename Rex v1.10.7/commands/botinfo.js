...
module.exports.run = async (client, message, args) => {
    ...
    .addField(`Version`, `${client.user.username} v1.10.7`, true)
    ...
    .addField(`Creator's YouTube`, `[Tsunami's YouTube](http://rexbot.ga/youtube)`, true)
    ...
    .addField(`Site`, `[rexbot.ga](http://rexbot.ga)`, true)
    .addField(`Support The Project`, `[Support ${client.user.username}](http://rexbot.ga/support)`)
    .addField(`Discord Bots List`, `[Discord Bots List](https://top.gg/bot/605385562152763395)`)
    .addField(`Language`, `🇬🇧 | English`, true)
    .addField(`Codelanguage`, `JavaScript (NodeJS)`, true)
    .addField(`Library`, `Discord.js`, true)
    .addField(`Total Commands Count`, `\`158\` Commands`)
    ...
    .addField(`Donator`, `LiL1ghtmare#0317`)
