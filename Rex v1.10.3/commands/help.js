...
module.exports.run = async (client, message, args) => {
  ...
  if(args[0] === `fun`) {
    ...
    .addField(`😂 | Fun (16)`, `\`${prefix}8ball\`, \`${prefix}calc\`, \`${prefix}chatbot\`, \`${prefix}coinflip\`, \`${prefix}geoip\`, \`${prefix}guessnr\`, \`${prefix}hack\`\`${prefix}joke\`, \`${prefix}level\`, \`${prefix}lyrics\`, \`${prefix}mcuserncheck\`, \`${prefix}penissize\`, \`${prefix}pokedex\`, \`${prefix}quote\`, \`${prefix}rps\`, \`${prefix}why\``)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
