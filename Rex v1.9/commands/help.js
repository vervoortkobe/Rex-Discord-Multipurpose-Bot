...
module.exports.run = async (client, message, args) => {
  ...
  if(message.channel.nsfw === false) {
    ...
    .addField(`😂 | Fun (41)`, `\`${prefix}level\`, \`${prefix}rps\`, \`${prefix}8ball\`, \`${prefix}penissize\`, \`${prefix}chatbot\`, \`${prefix}meme\`, \`${prefix}joke\`, \`${prefix}why\`, \`${prefix}comment\`, \`${prefix}dog\`, \`${prefix}shiba\`, \`${prefix}cat\`, \`${prefix}goose\`, \`${prefix}birb\`, \`${prefix}fox\`, \`${prefix}panda\`, \`${prefix}redpanda\`, \`${prefix}koala\`, \`${prefix}llama\`, \`${prefix}seal\`, \`${prefix}raccoon\`, \`${prefix}whale\`, \`${prefix}lizard\`, \`${prefix}quokka\`, \`${prefix}pika\`, \`${prefix}anime\`, \`${prefix}animeavatar\`, \`${prefix}waifu\`, \`${prefix}foxgirl\`, \`${prefix}wink\`, \`${prefix}hug\`, \`${prefix}cuddle\`, \`${prefix}pat\`, \`${prefix}tickle\`, \`${prefix}facepalm\`, \`${prefix}slap\`, \`${prefix}cry\`, \`${prefix}hack\`, \`${prefix}kill\`, \`${prefix}shoot\`, \`${prefix}suicide\`, \`${prefix}reverse\``)
