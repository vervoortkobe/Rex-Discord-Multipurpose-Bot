...
module.exports.run = async (client, message, args) => {
    ...
    message.channel.send(`🔫 | <@${message.author.id}> just shot <@${memberToFind.user.id}>!`);
