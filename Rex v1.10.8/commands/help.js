...
module.exports.run = async (client, message, args) => {
  ...
  if(args[0] === `other`) {
    ...
    .addField(`📁 | Other (13)`, `\`${prefix}apply\`, \`${prefix}avatar\`, \`${prefix}giveaway\`, \`${prefix}invitelb\`, \`${prefix}nickname\`, \`${prefix}onetwo\`, \`${prefix}poll\`, \`${prefix}say\`, \`${prefix}servercount\`, \`${prefix}serverinfo\`, \`${prefix}servericon\`, \`${prefix}verify\`, \`${prefix}whois\`, \`${prefix}yesno\``, true)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
