...
module.exports.run = async (client, message, args) => {
    ...
    if(args[0] === `mod` || args[0] === `moderation`) {
      ...
      .setFooter(`» Page 2/10`)
      return message.channel.send({ embeds: [ helpModEmbed ]})
      .then(message.react("⛑"))
      .then(m => {
        m.react("🤖");
        m.react("⛑");
    ...
    if(args[0] === `config` || args[0] === `configuration`) {
      ...
      .setFooter(`» Page 3/10`)
      return message.channel.send({ embeds: [ helpConfigEmbed ]})
    ...
    if(args[0] === `tickets`) {
      ...
      .setFooter(`» Page 4/10`)
      return message.channel.send({ embeds: [ helpTicketsEmbed ]})
      .then(message.react("🎫"))
      .then(m => {
        m.react("🤖");
        m.react("⛑");
    ...
    if(args[0] === `levels` || args[0] === `leveling` || args[0] === `lvls`) {
      ...
      .setFooter(`» Page 5/10`)
      return message.channel.send({ embeds: [ helpLevelsEmbed ]})
      .then(message.react("🆙"))
      .then(m => {
        m.react("🤖");
        m.react("⛑");
    ...
    if(args[0] === `other`) {
      ...
      .setFooter(`» Page 6/10`)
      return message.channel.send({ embeds: [ helpOtherEmbed ]})
      .then(message.react("📁"))
      .then(m => {
        m.react("🤖");
        m.react("⛑");
    ...
    if(args[0] === `fun`) {
      ...
      .setFooter(`» Page 7/10`)
      return message.channel.send({ embeds: [ helpFunEmbed ]})
      .then(message.react("😂"))
      .then(m => {
        m.react("🤖");
        m.react("⛑");
    ...
    if(args[0] === `imgs` || args[0] === `images`) {
      ...
      .setFooter(`» Page 8/10`)
      return message.channel.send({ embeds: [ helpImgsEmbed ]})
      .then(message.react("📷"))
      .then(m => {
        m.react("🤖");
        m.react("⛑");
    ...
    if(args[0] === `nsfw`) {
      if(message.channel.nsfw === false) {
        ...
        .setFooter(`» Page 9/10`)
        return message.channel.send({ embeds: [ helpNoNsfwEmbed ]})
        .then(message.react("🔞"))
        .then(m => {
          m.react("🤖");
          m.react("⛑");
    ...
    if(args[0] === `nsfw`) {
      if(message.channel.nsfw === true) {
        ...
        .setFooter(`» Page 9/10`)
        return message.channel.send({ embeds: [ helpNsfwEmbed ]})
        .then(message.react("🔞"))
        .then(m => {
          m.react("🤖");
          m.react("⛑");
    ...
    if(args[0] === `about`) {
      ...
      return message.channel.send({ embeds: [ helpAboutEmbed ]})
    ...
    if(args[0] === `owner`) {
      if(message.author.id === "408289224761016332") {
        ...
        return message.channel.send({ embeds: [ helpOwnerEmbed ]})
        .then(message.react("👑"))
        .then(m => {
          m.react("🤖");
          m.react("⛑");
