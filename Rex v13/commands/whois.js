...
module.exports.run = async (client, message, args) => {
    ...
    const earlyverifieddeveloper = client.emojis.cache.get("787778799898722394");
    ...
    const flags = {
      ...
      EARLY_VERIFIED_DEVELOPER: `${earlyverifieddeveloper} \`Early Verified Bot Developer\``
    }
    ...
    if(!args[0]) {
      ...
      return message.channel.send({ embeds: [ whoisEmbed ]})
      .then(message.react("👤"));
    }
