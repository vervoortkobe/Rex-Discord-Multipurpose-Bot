...
module.exports.run = async (client, message, args) => {
    ...
    if(!member.kickable) return message.channel.send(`❌ | Couldn't change your nickname, because you do not have the correct permissions (CHANGE_NICKNAME) to do this!`);
