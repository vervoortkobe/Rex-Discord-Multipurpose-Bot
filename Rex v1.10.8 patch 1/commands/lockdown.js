...
module.exports.run = async (client, message, args) => {
    ...
    if(!message.member.hasPermission('ADMINISTRATOR')) return message.channel.send(`❌ | Couldn't lock the channel down, because you do not have the correct permissions (ADMINISTRATOR) to do this!`);
