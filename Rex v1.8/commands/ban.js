...
module.exports.run = async (client, message, args) => {
    ...
    if(!message.member.hasPermission('BAN_MEMBERS')) return message.channel.send(`❌ | Couldn't ban the user, because you do not have the correct permission (BAN_MEMBERS) to do this!`);
    ...
    if(!member.bannable) 
      return message.reply("❌ | I couldn't ban this user! Does he/she have a higher role? Do I have ban permissions?");
    ...
    message.reply(`✅ | <@${message.author.id}> just **banned ${member.user.tag} because of: ${reason}**!`);
