...
module.exports.run = async (client, message, args) => {
  ...
  if(args[0] === `mod`) {
    ...
    .addField(`⛑ | Moderation (15)`, `\`${prefix}announce\`, \`${prefix}ban\`, \`${prefix}clear\`, \`${prefix}kick\`, \`${prefix}lockdown\`, \`${prefix}mute\`, \`${prefix}report\`, \`${prefix}tempban\`, \`${prefix}templock\`, \`${prefix}tempmute\`, \`${prefix}unban\`, \`${prefix}unlock\`, \`${prefix}unmute\`, \`${prefix}warn\``, true)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
  ...
  if(args[0] === `config`) {
    ...
    const helpConfigEmbed = new Discord.RichEmbed()
    .setColor(0xff0000)
    .setTitle(`🤖 | ${client.user.username} Help Config`)
    .addField(`⚙️ | Config (7)`, `\`${prefix}autorole\`, \`${prefix}joinleave\`, \`${prefix}prefix\`, \`${prefix}rex-apply\`, \`${prefix}rex-invitelogs\`, \`${prefix}rex-logs\`, \`${prefix}rex-msglogs\`, \`${prefix}rex-reports\``, true)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
  ...
  if(args[0] === `other`) {
    ...
    .addField(`📁 | Other (14)`, `\`${prefix}apply\`, \`${prefix}avatar\`, \`${prefix}giveaway\`, \`${prefix}invitelb\`, \`${prefix}nickname\`, \`${prefix}onetwo\`, \`${prefix}pickcolor\`, \`${prefix}poll\`, \`${prefix}say\`, \`${prefix}servercount\`, \`${prefix}serverinfo\`, \`${prefix}servericon\`, \`${prefix}verify\`, \`${prefix}whois\`, \`${prefix}yesno\``, true)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
  ...
  if(args[0] === `fun`) {
    ...
    .addField(`😂 | Fun (20)`, `\`${prefix}8ball\`, \`${prefix}binary\`, \`${prefix}calc\`, \`${prefix}chatbot\`, \`${prefix}coinflip\`, \`${prefix}geoip\`, \`${prefix}guessnr\`, \`${prefix}hack\`, \`${prefix}howgay\`, \`${prefix}joke\`, \`${prefix}level\`, \`${prefix}lyrics\`, \`${prefix}mcuserncheck\`, \`${prefix}penissize\`, \`${prefix}pokedex\`, \`${prefix}quote\`, \`${prefix}rps\`, \`${prefix}ship\`, \`${prefix}teamtrees\`, \`${prefix}why\``)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
  ...
  if(args[0] === `img`) {
    ...
    .addField(`📷 | Images (66)`, `\`${prefix}anime\`, \`${prefix}animeavatar\`, \`${prefix}bear\`, \`${prefix}birb\`, \`${prefix}blur\`, \`${prefix}blurple\`, \`${prefix}car\`, \`${prefix}cat\`, \`${prefix}comment\`, \`${prefix}cry\`, \`${prefix}cuddle\`, \`${prefix}dog\`, \`${prefix}dolphin\`, \`${prefix}eevee\`, \`${prefix}elephant\`, \`${prefix}facepalm\`, \`${prefix}fish\`, \`${prefix}food\`, \`${prefix}fox\`, \`${prefix}foxgirl\`, \`${prefix}gay\`, \`${prefix}giraffe\`, \`${prefix}glass\`, \`${prefix}goose\`, \`${prefix}greyscale\`, \`${prefix}hamster\`, \`${prefix}hippo\`, \`${prefix}horse\`, \`${prefix}hug\`, \`${prefix}invert\`, \`${prefix}kangaroo\`, \`${prefix}kill\`, \`${prefix}killerwhale\`, \`${prefix}koala\`, \`${prefix}lion\`, \`${prefix}lizard\`, \`${prefix}llama\`, \`${prefix}meme\`, \`${prefix}panda\`, \`${prefix}pat\`, \`${prefix}penguin\`, \`${prefix}pig\`, \`${prefix}pika\`, \`${prefix}pixelate\`,  \`${prefix}quokka\`, \`${prefix}raccoon\`, \`${prefix}redpanda\`, \`${prefix}reverse\`, \`${prefix}seal\`, \`${prefix}sepia\`, \`${prefix}shark\`, \`${prefix}shiba\`, \`${prefix}shoot\`, \`${prefix}slap\`, \`${prefix}snake\`, \`${prefix}spider\`, \`${prefix}spin\`, \`${prefix}suicide\`, \`${prefix}tickle\`, \`${prefix}trigger\`, \`${prefix}turtle\`, \`${prefix}waifu\`, \`${prefix}wasted\`, \`${prefix}weapon\`, \`${prefix}whale\`, \`${prefix}wink\``)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
  ...
  if(args[0] === `nsfw`) {
    if(message.channel.nsfw === true) {
      ...
      .setColor(0xff0000)
      .setTitle(`🤖 | ${client.user.username} Help Nsfw`)
      .addField(`🔞 | Nsfw (21)`, `\`${prefix}anal\`, \`${prefix}booty\`, \`${prefix}classic\`, \`${prefix}ero\`, \`${prefix}femdom\`, \`${prefix}hanal\`, \`${prefix}hbj\`, \`${prefix}hboobs\`, \`${prefix}hcum\`, \`${prefix}hentai\`, \`${prefix}hgif\`, \`${prefix}hpussy\`, \`${prefix}lesbian\`, \`${prefix}neko\`, \`${prefix}pokeporn\`, \`${prefix}pussy\`, \`${prefix}pwankg\`, \`${prefix}solo\`, \`${prefix}spank\`, \`${prefix}trap\`, \`${prefix}yuri\``)
      .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
  ...
  if(args[0] === `about`) {
    ...
    .addField(`📥 | About (16)`, `\`${prefix}aliases\`, \`${prefix}api\`, \`${prefix}botchangelog\`, \`${prefix}botinfo\`, \`${prefix}botstats\`\`${prefix}bugreport\`, \`${prefix}commandlist\`, \`${prefix}donate\`, \`${prefix}invite\`, \`${prefix}ping\`, \`${prefix}site\`, \`${prefix}suggest\`, \`${prefix}supportus\`, \`${prefix}support\`, \`${prefix}version\`, \`${prefix}youtube\``)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
  ...
  if(args[0] === `owner`) {
    ...
    .addField(`👑 | Owner (6)`, `\`${prefix}deop\`, \`${prefix}msg\`, \`${prefix}msgall\`, \`${prefix}op\`, \`${prefix}serverlist\`, \`${prefix}webhook\``)
    .setFooter(`© ${client.user.username} was made by Tsunami#6271`)
