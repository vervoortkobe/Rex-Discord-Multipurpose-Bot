...
module.exports.run = async (client, message, args) => {
    ...
    if(message.member.id === config.donator1 || 
       message.member.id === config.donator2 || 
       message.member.id === config.donator3 || 
       message.member.id === config.donator4 || 
       message.member.id === config.donator5
       ) {
      lvlmode = `Donator (2x)`
    }
    if(message.member.id === config.premium1 || 
       message.member.id === config.premium2 || 
       message.member.id === config.premium3 || 
       message.member.id === config.premium4 || 
       message.member.id === config.premium5
       ) {
      lvlmode = `Premium (2x)`
    } else {
      lvlmode = `Normal`
